 ...
 * 
 */
@WebServiceClient(name = "AdminService", targetNamespace = "http://wsserver/", wsdlLocation = "http://localhost:9001/admin?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADMINSERVICE_QNAME = new QName("http://wsserver/", "AdminService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9001/admin?wsdl");
    ...
    public Admin getAdminPort() {
        return super.getPort(new QName("http://wsserver/", "AdminPort"), Admin.class);
    }
    ...
    public Admin getAdminPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wsserver/", "AdminPort"), Admin.class, features);
    }
